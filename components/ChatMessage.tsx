      ...
      <div className={`flex ${isUsuario ? 'justify-end' : 'justify-start'} items-end`}>
        ...
        >
          ...
          <button 
            ...
            className={`absolute top-2 ${isUsuario ? 'left-2' : 'right-2'} p-1.5 rounded-full bg-white/20 dark:bg-gray-700/20 hover:bg-white/40 dark:hover:bg-gray-700/40 text-white/70 dark:text-gray-300`}
