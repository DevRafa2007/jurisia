  ...
  const handleEnviarMensagem = async (texto: string) => {
    ...
    try {
      ...
      try {
        ...
        throw new Error('Erro ao processar sua consulta no servidor.');
      }
    } catch (erro) {
        ...
        <div className="flex-1 flex flex-col overflow-hidden w-full h-full relative">
          ...
          <div className="relative flex flex-col flex-grow overflow-hidden">
            ...
            >
              ...
              {mensagens.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full p-2 sm:p-4 relative z-10 min-h-[300px]">
                ...
                <div className="space-y-2 sm:space-y-4 relative z-10 min-h-[300px]">
