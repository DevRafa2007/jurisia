        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <Link 
              ...
              className="px-4 sm:px-6 py-2 rounded-lg bg-gradient-to-r from-primary-600 to-sky-500 hover:from-primary-700 hover:to-sky-600 dark:from-primary-500 dark:to-sky-400 text-white shadow-md transition-all duration-300 text-sm sm:text-base"
            >
              Cadastrar
            </Link>
          </div>
            ...
            <div className="flex space-x-4 sm:space-x-8">
              {['Termos', 'Privacidade', 'Contato'].map((item, index) => (
                <a 
                  key={index}
                  href="#" 
                  className="text-sm sm:text-base text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors duration-300"
                >
                  {item}
                </a>
              ))}
