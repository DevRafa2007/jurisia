        ...
        {!sidebarAberta && user && (
          <div className="fixed bottom-6 left-6 z-50">
            <button
              ...
              className="flex items-center justify-center w-12 h-12 rounded-full bg-primary-600 hover:bg-primary-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-opacity-50"
              aria-label="Abrir menu de documentos"
              title="Abrir menu de documentos"
            >
